...
$id= $_GET["id"];
$cbd = new ConexaoBD();
    $sql = "select * from cadastro_fornecedor WHERE cpf_cnpj='$id'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>ALTERA CADASTRO DE CLIENTE PESSOA JURIDICA</title>
    ...
    <body>
                <div>ALTERA CADASTRO DE CLIENTE PESSOA JURIDICA</div>
                <form name = "cadastro-novo-fornecedor" action="AlteraFornecedor.php" method="POST">
