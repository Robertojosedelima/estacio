        ...
        <nav>
            <div class="item">
                ...
                <ul>
                    ...
                    <li><a href="../../br.com.autosistem.visao/crud.pedidos/GerenciaCadastroPedidos.php" onclick="window.open(this.href,'funcao','aling=right','width=580,height=400'); return false;" title="Gerencia Pedido" id="funcao">Pedido</a></li>
